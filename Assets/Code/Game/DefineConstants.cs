...
internal static class DefineConstants
{
	...
	public const uint MAXUINT32 = 0xffffffff;
	public const int MINUINT32 = 0;
	public const int MAXINT16 = 0x7fff;
	public const int MAXUINT16 = 0xffff;
	public const int MINUINT16 = 0;
	public const int DEVELOPMENT = 0;
	public const int SHAREWARE = 0;
	public const int LOCATIONINFO = 1;
	public const int SOFTWAREERROR = 1;
	public const int MEMORYCORRUPTIONTEST = 1;
	public const int PRECACHETEST = 0;
	public const int DATACORRUPTIONTEST = 0;
	public const int RANDOMNUMBERTEST = 0;
	public const string SETUPFILENAME = "DUKE3D.CFG";
	public const int MAXMOUSEBUTTONS = 3;
	public const int MAXJOYBUTTONS = 8;
	public const int MAXMODEMSTRING = 50;
	public const int MAXMACROS = 10;
	public const int MAXMACROLENGTH = 34;
	public const int PHONENUMBERLENGTH = 28;
	public const int PHONENAMELENGTH = 16;
	public const int MAXPHONEENTRIES = 10;
	public const int MAXFUNCTIONLENGTH = 30;
	public const int MAXAXISFUNCTIONLENGTH = 30;
	public const int MAXPLAYERNAMELENGTH = 11;
	public const int MAXRTSNAMELENGTH = 15;
	public const int MAXMOUSEAXES = 2;
	public const int MAXJOYAXES = 4;
	public const int MAXGAMEPADAXES = 2;
	public const int sc_None = 0;
	public const int sc_Bad = 0xff;
	public const int sc_Comma = 0x33;
	public const int sc_Period = 0x34;
	public const int sc_Return = 0x1c;
	public const int sc_Escape = 0x01;
	public const int sc_Space = 0x39;
	public const int sc_BackSpace = 0x0e;
	public const int sc_Tab = 0x0f;
	public const int sc_LeftAlt = 0x38;
	public const int sc_LeftControl = 0x1d;
	public const int sc_CapsLock = 0x3a;
	public const int sc_LeftShift = 0x2a;
	public const int sc_RightShift = 0x36;
	public const int sc_F1 = 0x3b;
	public const int sc_F2 = 0x3c;
	public const int sc_F3 = 0x3d;
	public const int sc_F4 = 0x3e;
	public const int sc_F5 = 0x3f;
	public const int sc_F6 = 0x40;
	public const int sc_F7 = 0x41;
	public const int sc_F8 = 0x42;
	public const int sc_F9 = 0x43;
	public const int sc_F10 = 0x44;
	public const int sc_F11 = 0x57;
	public const int sc_F12 = 0x58;
	public const int sc_Kpad_Star = 0x37;
	public const int sc_Pause = 0x59;
	public const int sc_ScrollLock = 0x46;
	public const int sc_NumLock = 0x45;
	public const int sc_Slash = 0x35;
	public const int sc_SemiColon = 0x27;
	public const int sc_Quote = 0x28;
	public const int sc_Tilde = 0x29;
	public const int sc_BackSlash = 0x2b;
	public const int sc_OpenBracket = 0x1a;
	public const int sc_CloseBracket = 0x1b;
	public const int sc_1 = 0x02;
	public const int sc_2 = 0x03;
	public const int sc_3 = 0x04;
	public const int sc_4 = 0x05;
	public const int sc_5 = 0x06;
	public const int sc_6 = 0x07;
	public const int sc_7 = 0x08;
	public const int sc_8 = 0x09;
	public const int sc_9 = 0x0a;
	public const int sc_0 = 0x0b;
	public const int sc_Minus = 0x0c;
	public const int sc_Equals = 0x0d;
	public const int sc_Plus = 0x0d;
	public const int sc_kpad_1 = 0x4f;
	public const int sc_kpad_2 = 0x50;
	public const int sc_kpad_3 = 0x51;
	public const int sc_kpad_4 = 0x4b;
	public const int sc_kpad_5 = 0x4c;
	public const int sc_kpad_6 = 0x4d;
	public const int sc_kpad_7 = 0x47;
	public const int sc_kpad_8 = 0x48;
	public const int sc_kpad_9 = 0x49;
	public const int sc_kpad_0 = 0x52;
	public const int sc_kpad_Minus = 0x4a;
	public const int sc_kpad_Plus = 0x4e;
	public const int sc_kpad_Period = 0x53;
	public const int sc_A = 0x1e;
	public const int sc_B = 0x30;
	public const int sc_C = 0x2e;
	public const int sc_D = 0x20;
	public const int sc_E = 0x12;
	public const int sc_F = 0x21;
	public const int sc_G = 0x22;
	public const int sc_H = 0x23;
	public const int sc_I = 0x17;
	public const int sc_J = 0x24;
	public const int sc_K = 0x25;
	public const int sc_L = 0x26;
	public const int sc_M = 0x32;
	public const int sc_N = 0x31;
	public const int sc_O = 0x18;
	public const int sc_P = 0x19;
	public const int sc_Q = 0x10;
	public const int sc_R = 0x13;
	public const int sc_S = 0x1f;
	public const int sc_T = 0x14;
	public const int sc_U = 0x16;
	public const int sc_V = 0x2f;
	public const int sc_W = 0x11;
	public const int sc_X = 0x2d;
	public const int sc_Y = 0x15;
	public const int sc_Z = 0x2c;
	public const int sc_UpArrow = 0x5a;
	public const int sc_DownArrow = 0x6a;
	public const int sc_LeftArrow = 0x6b;
	public const int sc_RightArrow = 0x6c;
	public const int sc_Insert = 0x5e;
	public const int sc_Delete = 0x5f;
	public const int sc_Home = 0x61;
	public const int sc_End = 0x62;
	public const int sc_PgUp = 0x63;
	public const int sc_PgDn = 0x64;
	public const int sc_RightAlt = 0x65;
	public const int sc_RightControl = 0x66;
	public const int sc_kpad_Slash = 0x67;
	public const int sc_kpad_Enter = 0x68;
	public const int sc_PrintScreen = 0x69;
	public const int sc_LastScanCode = 0x6e;
	public const int asc_Enter = 13;
	public const int asc_Escape = 27;
	public const int asc_BackSpace = 8;
	public const int asc_Tab = 9;
	public const int asc_Space = 32;
	public const int MAXKEYBOARDSCAN = 128;
	public const string ASS_VERSION_STRING = "1.1";
	public const int MonoFx = 1;
	public const int StereoFx = 2;
	public const string SETUPNAMEPARM = "SETUPFILE";
	public const int MaxJoys = 2;
	public const int MAXGAMEBUTTONS = 64;
	...
	public const int RESERVEDSLOT6 = 6137;
	public const int RESERVEDSLOT7 = 6138;
	public const int RESERVEDSLOT8 = 6139;
	public const int RESERVEDSLOT9 = 6140;
	public const int RESERVEDSLOT10 = 6141;
	public const int RESERVEDSLOT11 = 6142;
	public const int RESERVEDSLOT12 = 6143;
...
#if __SETUP__
	public const int NUMKEYENTRIES = 52;
#endif
	...
	public const int RIGHT_MOUSE = 2;
	public const int MIDDLE_MOUSE = 4;
