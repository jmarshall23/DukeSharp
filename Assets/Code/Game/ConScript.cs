internal class ConScript
{
    ...
    static GlobalMembers.ConActions.ConAction ANULLACTION = new GlobalMembers.ConActions.ConAction(0);
    public const int SPACESHUTTLE = 487;
    static GlobalMembers.ConActions.MoveAction SHUTTLEVELS = new GlobalMembers.ConActions.MoveAction(16);
    ...
    static GlobalMembers.ConActions.ConAction ASHARKCRUZING = new GlobalMembers.ConActions.ConAction(0, 8, 5, 1, 24);
    static GlobalMembers.ConActions.ConAction ASHARKFLEE = new GlobalMembers.ConActions.ConAction(0, 8, 5, 1, 10);
    static GlobalMembers.ConActions.ConAction ASHARKATACK = new GlobalMembers.ConActions.ConAction(0, 8, 5, 1, 6);
    static GlobalMembers.ConActions.ConAction ASHARKSHRUNK = new GlobalMembers.ConActions.ConAction(0, 8, 5, 1, 24);
    static GlobalMembers.ConActions.ConAction ASHARKGROW = new GlobalMembers.ConActions.ConAction(0, 8, 5, 1, 24);
    static GlobalMembers.ConActions.ConAction ASHARKFROZEN = new GlobalMembers.ConActions.ConAction(0, 1, 5, 1, 24);
    static GlobalMembers.ConActions.MoveAction SHARKVELS = new GlobalMembers.ConActions.MoveAction(24);
    static GlobalMembers.ConActions.MoveAction SHARKFASTVELS = new GlobalMembers.ConActions.MoveAction(72);
    static GlobalMembers.ConActions.MoveAction SHARKFLEEVELS = new GlobalMembers.ConActions.MoveAction(40);
                ...
                if (GlobalMembers.ConActions.ifcount(48))
                    if (GlobalMembers.ConActions.ifrnd(2))
                        if (GlobalMembers.ConActions.ifcanshoottarget())
                        {
                            ...
                            GlobalMembers.ConActions.Move(SHARKFASTVELS, faceplayerslow, getv);
                            return;
                        }
            if (GlobalMembers.ConActions.ifcount(32))
        ...
        if (GlobalMembers.ConActions.ifaction(ASHARKATACK))
        {
            if (GlobalMembers.ConActions.ifcount(4))
            {
                if (GlobalMembers.ConActions.ifpdistl(1280))
                {
                    ...
                    {
                        if (GlobalMembers.ConActions.ifcanshoottarget()) // jmarshall: hand change
                        {
    ...
    static GlobalMembers.ConActions.ConAction BLIMPWAITTORESPAWN = new GlobalMembers.ConActions.ConAction();
    ...
    private void A_BLIMP()
    {
        if (GlobalMembers.ConActions.ifaction(BLIMPWAITTORESPAWN))
        {
            ...
            {
                GlobalMembers.ConActions.SetAction(null);
                GlobalMembers.ConActions.cstat(0);
            }
            return;
        }
    ...
    static GlobalMembers.ConActions.MoveAction RESPAWN_ACTOR_FLAG = new GlobalMembers.ConActions.MoveAction();
    static GlobalMembers.ConActions.MoveAction MOUSEVELS = new GlobalMembers.ConActions.MoveAction(32);
    static GlobalMembers.ConActions.ConAction RUBCANDENT = new GlobalMembers.ConActions.ConAction(1, 1, 1, 1, 1);
    ...
    {
        if (GlobalMembers.ConActions.ifaction(null))
        {
            GlobalMembers.ConActions.SetAction(ANULLACTION);
    ...
    static GlobalMembers.ConActions.ConAction ABURGERROTS = new GlobalMembers.ConActions.ConAction(0, 1, 5);
    ...
    static GlobalMembers.ConActions.ConAction EXPBARRELFRAME = new GlobalMembers.ConActions.ConAction(0, 2, 1, 1, 15);
    ...
    static GlobalMembers.ConActions.ConAction BURNING_FLAME = new GlobalMembers.ConActions.ConAction(0, 12, 1, 1, 2);
    static GlobalMembers.ConActions.MoveAction BURNING_VELS = new GlobalMembers.ConActions.MoveAction();
    private void burningstate()
    {
        ...
        {
            if (GlobalMembers.ConActions.ifmove(null))
    ...
    static GlobalMembers.ConActions.ConAction TOILETWATERFRAMES = new GlobalMembers.ConActions.ConAction(0, 4, 1, 1, 1);
    ...
    static GlobalMembers.ConActions.ConAction WOODENHORSEFRAME = new GlobalMembers.ConActions.ConAction(0, 1, 4);
    static GlobalMembers.ConActions.ConAction WOODENFALLFRAME = new GlobalMembers.ConActions.ConAction(122, 1, 5);
    ...
    static GlobalMembers.ConActions.ConAction STEAMFRAMES = new GlobalMembers.ConActions.ConAction(0, 5, 1, 1, 1);
    ...
    static GlobalMembers.ConActions.ConAction BUBBLE = new GlobalMembers.ConActions.ConAction();
    static GlobalMembers.ConActions.ConAction CRACKEDBUBBLE = new GlobalMembers.ConActions.ConAction(1);
    static GlobalMembers.ConActions.MoveAction BUBMOVE = new GlobalMembers.ConActions.MoveAction(-10, -36);
    static GlobalMembers.ConActions.MoveAction BUBMOVEFAST = new GlobalMembers.ConActions.MoveAction(-10, -52);
    ...
    static GlobalMembers.ConActions.MoveAction SMOKEVEL = new GlobalMembers.ConActions.MoveAction(8, -16);
    static GlobalMembers.ConActions.MoveAction ENGINE_SMOKE = new GlobalMembers.ConActions.MoveAction(64, -64);
    static GlobalMembers.ConActions.MoveAction SMOKESHOOTOUT = new GlobalMembers.ConActions.MoveAction(-192);
    static GlobalMembers.ConActions.ConAction SMOKEFRAMES = new GlobalMembers.ConActions.ConAction(0, 4, 1, 1, 10);
    ...
    static GlobalMembers.ConActions.ConAction BARREL_DENTING = new GlobalMembers.ConActions.ConAction(2, 2, 1, 1, 6);
    static GlobalMembers.ConActions.ConAction BARREL_DENTED = new GlobalMembers.ConActions.ConAction(1);
    static GlobalMembers.ConActions.ConAction BARREL_DENTED2 = new GlobalMembers.ConActions.ConAction(2);
    static GlobalMembers.ConActions.MoveAction SPAWNED_BLOOD = new GlobalMembers.ConActions.MoveAction();
    ...
    static GlobalMembers.ConActions.ConAction SHRINKERFRAMES = new GlobalMembers.ConActions.ConAction(0, 4, 1, 1, 10);
    private void A_SHRINKEREXPLOSION()
    {
        if (GlobalMembers.ConActions.ifactioncount(4))
            GlobalMembers.ConActions.killit();
    }
    static GlobalMembers.ConActions.ConAction EXPLOSION_FRAMES = new GlobalMembers.ConActions.ConAction(0, 20, 1, 1, 4);
    ...
    static GlobalMembers.ConActions.ConAction FFLAME_FR = new GlobalMembers.ConActions.ConAction(0, 16, 1, 1, 1);
    static GlobalMembers.ConActions.ConAction FFLAME = new GlobalMembers.ConActions.ConAction(0, 1, 1, 1, 1);
    ...
    static GlobalMembers.ConActions.ConAction ASATNSPIN = new GlobalMembers.ConActions.ConAction(0, 5, 1, 1, 4);
    static GlobalMembers.ConActions.ConAction ASATSHOOTING = new GlobalMembers.ConActions.ConAction(-10, 3, 5, 1, 40);
    static GlobalMembers.ConActions.ConAction ASATWAIT = new GlobalMembers.ConActions.ConAction(0, 1, 5, 1, 1);
    static GlobalMembers.ConActions.MoveAction TURRVEL = new GlobalMembers.ConActions.MoveAction();
    ...
    static GlobalMembers.ConActions.ConAction RIP_F = new GlobalMembers.ConActions.ConAction(0, 8, 1, 1, 1);
    private void A_FORCERIPPLE()
    {
        if (GlobalMembers.ConActions.ifactioncount(8))
            GlobalMembers.ConActions.killit();
    }
    static GlobalMembers.ConActions.ConAction TRANSFOWARD = new GlobalMembers.ConActions.ConAction(0, 6, 1, 1, 2);
    static GlobalMembers.ConActions.ConAction TRANSBACK = new GlobalMembers.ConActions.ConAction(5, 6, 1, -1, 2);
    ...
    static GlobalMembers.ConActions.ConAction BEAMFOWARD = new GlobalMembers.ConActions.ConAction(0, 4, 1, 1, 9);
    ...
    static GlobalMembers.ConActions.ConAction HOLODUKE_FRAMES = new GlobalMembers.ConActions.ConAction(0, 4, 1, 1, 8);
    ...
    static GlobalMembers.ConActions.ConAction FIRE_FRAMES = new GlobalMembers.ConActions.ConAction(-1, 14, 1, 1, 1);
    static GlobalMembers.ConActions.MoveAction FIREVELS = new GlobalMembers.ConActions.MoveAction();
    ...
    static GlobalMembers.ConActions.ConAction FEMSHRUNK = new GlobalMembers.ConActions.ConAction();
    static GlobalMembers.ConActions.ConAction FEMFROZEN1 = new GlobalMembers.ConActions.ConAction(1);
    static GlobalMembers.ConActions.ConAction FEMGROW = new GlobalMembers.ConActions.ConAction();
    static GlobalMembers.ConActions.ConAction FEMFROZEN2 = new GlobalMembers.ConActions.ConAction();
    static GlobalMembers.ConActions.ConAction FEMDANCE1 = new GlobalMembers.ConActions.ConAction(19, 1, 1, 1, 16);
    static GlobalMembers.ConActions.ConAction FEMDANCE3 = new GlobalMembers.ConActions.ConAction(19, 1, 1, 1, 26);
    static GlobalMembers.ConActions.ConAction FEMDANCE2 = new GlobalMembers.ConActions.ConAction(20, 2, 1, 1, 10);
    static GlobalMembers.ConActions.ConAction FEMANIMATESLOW = new GlobalMembers.ConActions.ConAction(0, 2, 1, 1, 100);
    static GlobalMembers.ConActions.ConAction TOUGHGALANIM = new GlobalMembers.ConActions.ConAction(0, 5, 1, 1, 25);
    static GlobalMembers.ConActions.ConAction FEMANIMATE = new GlobalMembers.ConActions.ConAction();
    ...
    static GlobalMembers.ConActions.ConAction BLOODFRAMES = new GlobalMembers.ConActions.ConAction(0, 4, 1, 1, 15);
    ...
    static GlobalMembers.ConActions.ConAction EGGOPEN1 = new GlobalMembers.ConActions.ConAction(1, 1, 1, 1, 4);
    static GlobalMembers.ConActions.ConAction EGGOPEN2 = new GlobalMembers.ConActions.ConAction(2, 1, 1, 1, 4);
    static GlobalMembers.ConActions.ConAction EGGOPEN3 = new GlobalMembers.ConActions.ConAction(2, 1, 1, 1, 4);
    static GlobalMembers.ConActions.ConAction EGGWAIT = new GlobalMembers.ConActions.ConAction(0);
    static GlobalMembers.ConActions.ConAction EGGFROZEN = new GlobalMembers.ConActions.ConAction(1);
    static GlobalMembers.ConActions.ConAction EGGGROW = new GlobalMembers.ConActions.ConAction(1);
    static GlobalMembers.ConActions.ConAction EGGSHRUNK = new GlobalMembers.ConActions.ConAction(1);
    private void A_EGG()
    {
        GlobalMembers.ConActions.fall();
        if (GlobalMembers.ConActions.ifaction(null))
    ...
    static GlobalMembers.ConActions.ConAction WEAP2FRAMES = new GlobalMembers.ConActions.ConAction(0, 4, 1, 1, 6);
    ...
    static GlobalMembers.ConActions.MoveAction DUKENOTMOVING = new GlobalMembers.ConActions.MoveAction();
    ...
    static GlobalMembers.ConActions.ConAction PLYINGFRAMES = new GlobalMembers.ConActions.ConAction(0, 1, 0, 1, 1);
    private void A_DUKELYINGDEAD()
    {
        handle_dead_dukes();
    }
    static GlobalMembers.ConActions.ConAction PGROWING = new GlobalMembers.ConActions.ConAction(0);
    static GlobalMembers.ConActions.ConAction PSTAND = new GlobalMembers.ConActions.ConAction(0, 1, 5, 1, 1);
    static GlobalMembers.ConActions.ConAction PEXPLODE = new GlobalMembers.ConActions.ConAction(106, 5, 1, 1, 10);
    static GlobalMembers.ConActions.ConAction PEXPLODEAD = new GlobalMembers.ConActions.ConAction(113, 1, 1);
    static GlobalMembers.ConActions.ConAction PJPHOUVER = new GlobalMembers.ConActions.ConAction(15, 1, 5, 1);
    static GlobalMembers.ConActions.ConAction PWALK = new GlobalMembers.ConActions.ConAction(20, 4, 5, 1, 16);
    static GlobalMembers.ConActions.ConAction PRUN = new GlobalMembers.ConActions.ConAction(20, 4, 5, 1, 10);
    static GlobalMembers.ConActions.ConAction PWALKBACK = new GlobalMembers.ConActions.ConAction(45, 4, 5, -1, 16);
    static GlobalMembers.ConActions.ConAction PRUNBACK = new GlobalMembers.ConActions.ConAction(45, 4, 5, -1, 10);
    static GlobalMembers.ConActions.ConAction PJUMPING = new GlobalMembers.ConActions.ConAction(50, 4, 5, 1, 30);
    static GlobalMembers.ConActions.ConAction PFALLING = new GlobalMembers.ConActions.ConAction(65, 1, 5);
    static GlobalMembers.ConActions.ConAction PDUCKING = new GlobalMembers.ConActions.ConAction(86, 1, 5);
    static GlobalMembers.ConActions.ConAction PCRAWLING = new GlobalMembers.ConActions.ConAction(86, 3, 5, 1, 20);
    static GlobalMembers.ConActions.ConAction PAKICKING = new GlobalMembers.ConActions.ConAction(40, 2, 5, 1, 25);
    static GlobalMembers.ConActions.ConAction PFLINTCHING = new GlobalMembers.ConActions.ConAction(106, 1, 1, 1, 10);
    static GlobalMembers.ConActions.ConAction PTHROWNBACK = new GlobalMembers.ConActions.ConAction(106, 5, 1, 1, 18);
    static GlobalMembers.ConActions.ConAction PFROZEN = new GlobalMembers.ConActions.ConAction(20, 1, 5);
    static GlobalMembers.ConActions.ConAction PLYINGDEAD = new GlobalMembers.ConActions.ConAction(113, 1, 1);
    static GlobalMembers.ConActions.ConAction PSWIMMINGGO = new GlobalMembers.ConActions.ConAction(375, 1, 5, 1, 10);
    static GlobalMembers.ConActions.ConAction PSWIMMING = new GlobalMembers.ConActions.ConAction(375, 4, 5, 1, 13);
    static GlobalMembers.ConActions.ConAction PSWIMMINGWAIT = new GlobalMembers.ConActions.ConAction(395, 1, 5, 1, 13);
    static GlobalMembers.ConActions.ConAction PTREDWATER = new GlobalMembers.ConActions.ConAction(395, 2, 5, 1, 17);
    static GlobalMembers.ConActions.MoveAction PSTOPED = new GlobalMembers.ConActions.MoveAction();
    static GlobalMembers.ConActions.MoveAction PSHRINKING = new GlobalMembers.ConActions.MoveAction();
    ...
    static GlobalMembers.ConActions.MoveAction PGROWINGPOP = new GlobalMembers.ConActions.MoveAction();
    ...
    static GlobalMembers.ConActions.ConAction ATROOPSTAND = new GlobalMembers.ConActions.ConAction(0, 1, 5, 1, 1);
    static GlobalMembers.ConActions.ConAction ATROOPGROW = new GlobalMembers.ConActions.ConAction(0, 1, 5, 1, 1);
    static GlobalMembers.ConActions.ConAction ATROOPSTAYSTAND = new GlobalMembers.ConActions.ConAction(-2, 1, 5, 1, 1);
    static GlobalMembers.ConActions.ConAction ATROOPWALKING = new GlobalMembers.ConActions.ConAction(0, 4, 5, 1, 12);
    static GlobalMembers.ConActions.ConAction ATROOPWALKINGBACK = new GlobalMembers.ConActions.ConAction(15, 4, 5, -1, 12);
    static GlobalMembers.ConActions.ConAction ATROOPRUNNING = new GlobalMembers.ConActions.ConAction(0, 4, 5, 1, 8);
    static GlobalMembers.ConActions.ConAction ATROOPSHOOT = new GlobalMembers.ConActions.ConAction(35, 1, 5, 1, 30);
    static GlobalMembers.ConActions.ConAction ATROOPJETPACK = new GlobalMembers.ConActions.ConAction(40, 1, 5, 1, 1);
    static GlobalMembers.ConActions.ConAction ATROOPJETPACKILL = new GlobalMembers.ConActions.ConAction(40, 2, 5, 1, 50);
    static GlobalMembers.ConActions.ConAction ATROOPFLINTCH = new GlobalMembers.ConActions.ConAction(50, 1, 1, 1, 6);
    static GlobalMembers.ConActions.ConAction ATROOPDYING = new GlobalMembers.ConActions.ConAction(50, 5, 1, 1, 16);
    static GlobalMembers.ConActions.ConAction ATROOPDEAD = new GlobalMembers.ConActions.ConAction(54);
    static GlobalMembers.ConActions.ConAction ATROOPPLAYDEAD = new GlobalMembers.ConActions.ConAction(54);
    static GlobalMembers.ConActions.ConAction ATROOPSUFFERDEAD = new GlobalMembers.ConActions.ConAction(58, 2, 1, -4, 24);
    static GlobalMembers.ConActions.ConAction ATROOPSUFFERING = new GlobalMembers.ConActions.ConAction(59, 2, 1, 1, 21);
    static GlobalMembers.ConActions.ConAction ATROOPDUCK = new GlobalMembers.ConActions.ConAction(64, 1, 5, 1, 3);
    static GlobalMembers.ConActions.ConAction ATROOPDUCKSHOOT = new GlobalMembers.ConActions.ConAction(64, 2, 5, 1, 25);
    static GlobalMembers.ConActions.ConAction ATROOPABOUTHIDE = new GlobalMembers.ConActions.ConAction(74, 1, 1, 1, 25);
    static GlobalMembers.ConActions.ConAction ATROOPHIDE = new GlobalMembers.ConActions.ConAction(79, 1, 1, 1, 25);
    static GlobalMembers.ConActions.ConAction ATROOPREAPPEAR = new GlobalMembers.ConActions.ConAction(74, 1, 1, 1, 25);
    static GlobalMembers.ConActions.ConAction ATROOPFROZEN = new GlobalMembers.ConActions.ConAction(0, 1, 5);
    static GlobalMembers.ConActions.MoveAction TROOPWALKVELS = new GlobalMembers.ConActions.MoveAction(72);
    static GlobalMembers.ConActions.MoveAction TROOPWALKVELSBACK = new GlobalMembers.ConActions.MoveAction(-72);
    static GlobalMembers.ConActions.MoveAction TROOPJETPACKVELS = new GlobalMembers.ConActions.MoveAction(64, -84);
    static GlobalMembers.ConActions.MoveAction TROOPJETPACKILLVELS = new GlobalMembers.ConActions.MoveAction(192, -38);
    static GlobalMembers.ConActions.MoveAction TROOPRUNVELS = new GlobalMembers.ConActions.MoveAction(108);
    static GlobalMembers.ConActions.MoveAction TROOPSTOPPED = new GlobalMembers.ConActions.MoveAction();
    static GlobalMembers.ConActions.MoveAction DONTGETUP = new GlobalMembers.ConActions.MoveAction();
    static GlobalMembers.ConActions.MoveAction SHRUNKVELS = new GlobalMembers.ConActions.MoveAction(32);
    static GlobalMembers.ConActions.AIAction AITROOPSEEKENEMY = new GlobalMembers.ConActions.AIAction(ATROOPWALKING, TROOPWALKVELS, seekplayer);
    static GlobalMembers.ConActions.AIAction AITROOPSEEKPLAYER = new GlobalMembers.ConActions.AIAction(ATROOPWALKING, TROOPWALKVELS, seekplayer);
    static GlobalMembers.ConActions.AIAction AITROOPFLEEING = new GlobalMembers.ConActions.AIAction(ATROOPWALKING, TROOPWALKVELS, fleeenemy);
    static GlobalMembers.ConActions.AIAction AITROOPFLEEINGBACK = new GlobalMembers.ConActions.AIAction(ATROOPWALKINGBACK, TROOPWALKVELSBACK, faceplayer);
    static GlobalMembers.ConActions.AIAction AITROOPDODGE = new GlobalMembers.ConActions.AIAction(ATROOPWALKING, TROOPRUNVELS, dodgebullet);
    static GlobalMembers.ConActions.AIAction AITROOPSHOOTING = new GlobalMembers.ConActions.AIAction(ATROOPSHOOT, TROOPSTOPPED, faceplayer);
    static GlobalMembers.ConActions.AIAction AITROOPDUCKING = new GlobalMembers.ConActions.AIAction(ATROOPDUCK, TROOPSTOPPED, faceplayer);
    static GlobalMembers.ConActions.AIAction AITROOPJETPACK = new GlobalMembers.ConActions.AIAction(ATROOPJETPACK, TROOPJETPACKVELS, seekplayer);
    static GlobalMembers.ConActions.AIAction AITROOPSHRUNK = new GlobalMembers.ConActions.AIAction(ATROOPWALKING, SHRUNKVELS, fleeenemy);
    static GlobalMembers.ConActions.AIAction AITROOPHIDE = new GlobalMembers.ConActions.AIAction(ATROOPABOUTHIDE, TROOPSTOPPED, faceplayer);
    static GlobalMembers.ConActions.AIAction AITROOPGROW = new GlobalMembers.ConActions.AIAction(ATROOPGROW, DONTGETUP, faceplayerslow);
    ...
    {
        if (GlobalMembers.ConActions.ifai(null))
        {
    ...
    static GlobalMembers.ConActions.ConAction ALIZSTAND = new GlobalMembers.ConActions.ConAction(0);
    static GlobalMembers.ConActions.ConAction ALIZWALKING = new GlobalMembers.ConActions.ConAction(0, 4, 5, 1, 15);
    static GlobalMembers.ConActions.ConAction ALIZRUNNING = new GlobalMembers.ConActions.ConAction(0, 4, 5, 1, 11);
    static GlobalMembers.ConActions.ConAction ALIZTHINK = new GlobalMembers.ConActions.ConAction(20, 2, 5, 1, 40);
    static GlobalMembers.ConActions.ConAction ALIZSCREAM = new GlobalMembers.ConActions.ConAction(30, 1, 5, 1, 2);
    static GlobalMembers.ConActions.ConAction ALIZJUMP = new GlobalMembers.ConActions.ConAction(45, 3, 5, 1, 20);
    static GlobalMembers.ConActions.ConAction ALIZFALL = new GlobalMembers.ConActions.ConAction(55, 1, 5);
    static GlobalMembers.ConActions.ConAction ALIZSHOOTING = new GlobalMembers.ConActions.ConAction(70, 2, 5, 1, 7);
    static GlobalMembers.ConActions.ConAction ALIZDYING = new GlobalMembers.ConActions.ConAction(60, 6, 1, 1, 15);
    static GlobalMembers.ConActions.ConAction ALIZLYINGDEAD = new GlobalMembers.ConActions.ConAction(65, 1);
    static GlobalMembers.ConActions.ConAction ALIZFROZEN = new GlobalMembers.ConActions.ConAction(0, 1, 5);
    static GlobalMembers.ConActions.MoveAction LIZWALKVEL = new GlobalMembers.ConActions.MoveAction(72);
    static GlobalMembers.ConActions.MoveAction LIZRUNVEL = new GlobalMembers.ConActions.MoveAction(192);
    static GlobalMembers.ConActions.MoveAction LIZJUMPVEL = new GlobalMembers.ConActions.MoveAction(184);
    static GlobalMembers.ConActions.MoveAction LIZSTOP = new GlobalMembers.ConActions.MoveAction();
    static GlobalMembers.ConActions.AIAction AILIZGETENEMY = new GlobalMembers.ConActions.AIAction(ALIZWALKING, LIZWALKVEL, seekplayer);
    static GlobalMembers.ConActions.AIAction AILIZDODGE = new GlobalMembers.ConActions.AIAction(ALIZRUNNING, LIZRUNVEL, dodgebullet);
    static GlobalMembers.ConActions.AIAction AILIZCHARGEENEMY = new GlobalMembers.ConActions.AIAction(ALIZRUNNING, LIZRUNVEL, seekplayer);
    static GlobalMembers.ConActions.AIAction AILIZFLEENEMY = new GlobalMembers.ConActions.AIAction(ALIZWALKING, LIZWALKVEL, fleeenemy);
    static GlobalMembers.ConActions.AIAction AILIZSHOOTENEMY = new GlobalMembers.ConActions.AIAction(ALIZSHOOTING, LIZSTOP, faceplayer);
    static GlobalMembers.ConActions.AIAction AILIZJUMPENEMY = new GlobalMembers.ConActions.AIAction(ALIZJUMP, LIZJUMPVEL, jumptoplayer);
    static GlobalMembers.ConActions.AIAction AILIZTHINK = new GlobalMembers.ConActions.AIAction(ALIZTHINK, LIZSTOP, faceplayerslow);
    static GlobalMembers.ConActions.AIAction AILIZSHRUNK = new GlobalMembers.ConActions.AIAction(ALIZWALKING, SHRUNKVELS, fleeenemy);
    static GlobalMembers.ConActions.AIAction AILIZGROW = new GlobalMembers.ConActions.AIAction(ALIZSTAND, LIZSTOP, faceplayerslow);
    static GlobalMembers.ConActions.AIAction AILIZSPIT = new GlobalMembers.ConActions.AIAction(ALIZSCREAM, LIZSTOP, faceplayerslow);
    static GlobalMembers.ConActions.AIAction AILIZDYING = new GlobalMembers.ConActions.AIAction(ALIZDYING, LIZSTOP, faceplayer);
    ...
    {
        GlobalMembers.ConActions.Ai(AILIZGETENEMY);
        GlobalMembers.ConActions.cactor(LIZMAN);
    }
    ...
    static GlobalMembers.ConActions.ConAction DRONEFRAMES = new GlobalMembers.ConActions.ConAction(0, 1, 7, 1, 1);
    static GlobalMembers.ConActions.ConAction DRONESCREAM = new GlobalMembers.ConActions.ConAction(0, 1, 7, 1, 1);
    static GlobalMembers.ConActions.MoveAction DRONERUNVELS = new GlobalMembers.ConActions.MoveAction(128, 64);
    static GlobalMembers.ConActions.MoveAction DRONERUNUPVELS = new GlobalMembers.ConActions.MoveAction(128, -64);
    static GlobalMembers.ConActions.MoveAction DRONEBULLVELS = new GlobalMembers.ConActions.MoveAction(252, -64);
    static GlobalMembers.ConActions.MoveAction DRONEBACKWARDS = new GlobalMembers.ConActions.MoveAction(-64, -64);
    static GlobalMembers.ConActions.MoveAction DRONERISE = new GlobalMembers.ConActions.MoveAction(32, -32);
    static GlobalMembers.ConActions.MoveAction DRONESTOPPED = new GlobalMembers.ConActions.MoveAction(-16);
    static GlobalMembers.ConActions.AIAction AIDRONEGETE = new GlobalMembers.ConActions.AIAction(DRONESCREAM, DRONERUNVELS, faceplayerslow, getv);
    static GlobalMembers.ConActions.AIAction AIDRONEWAIT = new GlobalMembers.ConActions.AIAction(DRONEFRAMES, DRONESTOPPED, faceplayerslow);
    static GlobalMembers.ConActions.AIAction AIDRONEGETUP = new GlobalMembers.ConActions.AIAction(DRONESCREAM, DRONERUNUPVELS, faceplayer, getv);
    static GlobalMembers.ConActions.AIAction AIDRONEPULLBACK = new GlobalMembers.ConActions.AIAction(DRONEFRAMES, DRONEBACKWARDS, faceplayerslow);
    static GlobalMembers.ConActions.AIAction AIDRONEHIT = new GlobalMembers.ConActions.AIAction(DRONESCREAM, DRONEBACKWARDS, faceplayer);
    static GlobalMembers.ConActions.AIAction AIDRONESHRUNK = new GlobalMembers.ConActions.AIAction(DRONEFRAMES, SHRUNKVELS, fleeenemy);
    static GlobalMembers.ConActions.AIAction AIDRONEDODGE = new GlobalMembers.ConActions.AIAction(DRONEFRAMES, DRONEBULLVELS, dodgebullet, geth);
    static GlobalMembers.ConActions.AIAction AIDRONEDODGEUP = new GlobalMembers.ConActions.AIAction(DRONEFRAMES, DRONERISE, getv, geth);
    ...
    static GlobalMembers.ConActions.ConAction AOCTAWALK = new GlobalMembers.ConActions.ConAction(0, 3, 5, 1, 15);
    static GlobalMembers.ConActions.ConAction AOCTASTAND = new GlobalMembers.ConActions.ConAction(0, 1, 5, 1, 15);
    static GlobalMembers.ConActions.ConAction AOCTASCRATCH = new GlobalMembers.ConActions.ConAction(0, 4, 5, 1, 15);
    static GlobalMembers.ConActions.ConAction AOCTAHIT = new GlobalMembers.ConActions.ConAction(30, 1, 1, 1, 10);
    static GlobalMembers.ConActions.ConAction AOCTASHOOT = new GlobalMembers.ConActions.ConAction(20, 1, 5, 1, 10);
    static GlobalMembers.ConActions.ConAction AOCTADYING = new GlobalMembers.ConActions.ConAction(30, 8, 1, 1, 17);
    static GlobalMembers.ConActions.ConAction AOCTADEAD = new GlobalMembers.ConActions.ConAction(38, 1, 1, 1, 1);
    static GlobalMembers.ConActions.ConAction AOCTAFROZEN = new GlobalMembers.ConActions.ConAction(0, 1, 5);
    static GlobalMembers.ConActions.MoveAction OCTAWALKVELS = new GlobalMembers.ConActions.MoveAction(96, -30);
    static GlobalMembers.ConActions.MoveAction OCTAUPVELS = new GlobalMembers.ConActions.MoveAction(96, -70);
    static GlobalMembers.ConActions.MoveAction OCTASTOPPED = new GlobalMembers.ConActions.MoveAction(0, -30);
    static GlobalMembers.ConActions.MoveAction OCTAINWATER = new GlobalMembers.ConActions.MoveAction(96, 24);
    static GlobalMembers.ConActions.AIAction AIOCTAGETENEMY = new GlobalMembers.ConActions.AIAction(AOCTAWALK, OCTAWALKVELS, seekplayer);
    static GlobalMembers.ConActions.AIAction AIOCTASHOOTENEMY = new GlobalMembers.ConActions.AIAction(AOCTASHOOT, OCTASTOPPED, faceplayer);
    static GlobalMembers.ConActions.AIAction AIOCTASCRATCHENEMY = new GlobalMembers.ConActions.AIAction(AOCTASCRATCH, OCTASTOPPED, faceplayerslow);
    static GlobalMembers.ConActions.AIAction AIOCTAHIT = new GlobalMembers.ConActions.AIAction(AOCTAHIT, OCTASTOPPED, faceplayer);
    static GlobalMembers.ConActions.AIAction AIOCTASHRUNK = new GlobalMembers.ConActions.AIAction(AOCTAWALK, SHRUNKVELS, faceplayer);
    static GlobalMembers.ConActions.AIAction AIOCTAGROW = new GlobalMembers.ConActions.AIAction(AOCTASTAND, OCTASTOPPED, faceplayerslow);
    static GlobalMembers.ConActions.AIAction AIOCTADYING = new GlobalMembers.ConActions.AIAction(AOCTADYING, OCTASTOPPED, faceplayer);
    ...
    static GlobalMembers.ConActions.ConAction APIGWALK = new GlobalMembers.ConActions.ConAction(0, 4, 5, 1, 20);
    static GlobalMembers.ConActions.ConAction APIGRUN = new GlobalMembers.ConActions.ConAction(0, 4, 5, 1, 11);
    static GlobalMembers.ConActions.ConAction APIGSHOOT = new GlobalMembers.ConActions.ConAction(30, 2, 5, 1, 58);
    static GlobalMembers.ConActions.ConAction APIGCOCK = new GlobalMembers.ConActions.ConAction(25, 1, 5, 1, 16);
    static GlobalMembers.ConActions.ConAction APIGSTAND = new GlobalMembers.ConActions.ConAction(30, 1, 5, 1, 1);
    static GlobalMembers.ConActions.ConAction APIGDIVE = new GlobalMembers.ConActions.ConAction(40, 2, 5, 1, 40);
    static GlobalMembers.ConActions.ConAction APIGDIVESHOOT = new GlobalMembers.ConActions.ConAction(45, 2, 5, 1, 58);
    static GlobalMembers.ConActions.ConAction APIGDYING = new GlobalMembers.ConActions.ConAction(55, 5, 1, 1, 15);
    static GlobalMembers.ConActions.ConAction APIGHIT = new GlobalMembers.ConActions.ConAction(55, 1, 1, 1, 10);
    static GlobalMembers.ConActions.ConAction APIGDEAD = new GlobalMembers.ConActions.ConAction(60, 1, 1, 1, 1);
    static GlobalMembers.ConActions.ConAction APIGFROZEN = new GlobalMembers.ConActions.ConAction(0, 1, 5);
    static GlobalMembers.ConActions.ConAction APIGGROW = new GlobalMembers.ConActions.ConAction(0);
    static GlobalMembers.ConActions.MoveAction PIGWALKVELS = new GlobalMembers.ConActions.MoveAction(72);
    static GlobalMembers.ConActions.MoveAction PIGRUNVELS = new GlobalMembers.ConActions.MoveAction(108);
    static GlobalMembers.ConActions.MoveAction PIGSTOPPED = new GlobalMembers.ConActions.MoveAction();
    static GlobalMembers.ConActions.AIAction AIPIGSEEKENEMY = new GlobalMembers.ConActions.AIAction(APIGWALK, PIGWALKVELS, seekplayer);
    static GlobalMembers.ConActions.AIAction AIPIGSHOOTENEMY = new GlobalMembers.ConActions.AIAction(APIGSHOOT, PIGSTOPPED, faceplayer);
    static GlobalMembers.ConActions.AIAction AIPIGFLEEENEMY = new GlobalMembers.ConActions.AIAction(APIGWALK, PIGWALKVELS, fleeenemy);
    static GlobalMembers.ConActions.AIAction AIPIGSHOOT = new GlobalMembers.ConActions.AIAction(APIGSHOOT, PIGSTOPPED, faceplayer);
    static GlobalMembers.ConActions.AIAction AIPIGDODGE = new GlobalMembers.ConActions.AIAction(APIGRUN, PIGRUNVELS, dodgebullet);
    static GlobalMembers.ConActions.AIAction AIPIGCHARGE = new GlobalMembers.ConActions.AIAction(APIGRUN, PIGRUNVELS, seekplayer);
    static GlobalMembers.ConActions.AIAction AIPIGDIVING = new GlobalMembers.ConActions.AIAction(APIGDIVE, PIGSTOPPED, faceplayer);
    static GlobalMembers.ConActions.AIAction AIPIGDYING = new GlobalMembers.ConActions.AIAction(APIGDYING, PIGSTOPPED, faceplayer);
    static GlobalMembers.ConActions.AIAction AIPIGSHRINK = new GlobalMembers.ConActions.AIAction(APIGWALK, SHRUNKVELS, fleeenemy);
    static GlobalMembers.ConActions.AIAction AIPIGGROW = new GlobalMembers.ConActions.AIAction(APIGGROW, PIGSTOPPED, faceplayerslow);
    static GlobalMembers.ConActions.AIAction AIPIGHIT = new GlobalMembers.ConActions.AIAction(APIGHIT, PIGSTOPPED, faceplayer);
    ...
    static GlobalMembers.ConActions.ConAction ABOSS1WALK = new GlobalMembers.ConActions.ConAction(0, 4, 5, 1, 12);
    static GlobalMembers.ConActions.ConAction ABOSS1FROZEN = new GlobalMembers.ConActions.ConAction(30, 1, 5);
    static GlobalMembers.ConActions.ConAction ABOSS1RUN = new GlobalMembers.ConActions.ConAction(0, 6, 5, 1, 5);
    static GlobalMembers.ConActions.ConAction ABOSS1SHOOT = new GlobalMembers.ConActions.ConAction(30, 2, 5, 1, 4);
    static GlobalMembers.ConActions.ConAction ABOSS1LOB = new GlobalMembers.ConActions.ConAction(40, 2, 5, 1, 35);
    static GlobalMembers.ConActions.ConAction ABOSS1DYING = new GlobalMembers.ConActions.ConAction(50, 5, 1, 1, 35);
    static GlobalMembers.ConActions.ConAction BOSS1FLINTCH = new GlobalMembers.ConActions.ConAction(50, 1, 1, 1, 1);
    static GlobalMembers.ConActions.ConAction ABOSS1DEAD = new GlobalMembers.ConActions.ConAction(55);
    static GlobalMembers.ConActions.MoveAction PALBOSS1SHRUNKRUNVELS = new GlobalMembers.ConActions.MoveAction(32);
    static GlobalMembers.ConActions.MoveAction PALBOSS1RUNVELS = new GlobalMembers.ConActions.MoveAction(128);
    static GlobalMembers.ConActions.MoveAction BOSS1WALKVELS = new GlobalMembers.ConActions.MoveAction(208);
    static GlobalMembers.ConActions.MoveAction BOSS1RUNVELS = new GlobalMembers.ConActions.MoveAction(296);
    static GlobalMembers.ConActions.MoveAction BOSS1STOPPED = new GlobalMembers.ConActions.MoveAction();
    static GlobalMembers.ConActions.AIAction AIBOSS1SEEKENEMY = new GlobalMembers.ConActions.AIAction(ABOSS1WALK, BOSS1WALKVELS, seekplayer);
    static GlobalMembers.ConActions.AIAction AIBOSS1RUNENEMY = new GlobalMembers.ConActions.AIAction(ABOSS1RUN, BOSS1RUNVELS, faceplayer);
    static GlobalMembers.ConActions.AIAction AIBOSS1SHOOTENEMY = new GlobalMembers.ConActions.AIAction(ABOSS1SHOOT, BOSS1STOPPED, faceplayer);
    static GlobalMembers.ConActions.AIAction AIBOSS1LOBBED = new GlobalMembers.ConActions.AIAction(ABOSS1LOB, BOSS1STOPPED, faceplayer);
    static GlobalMembers.ConActions.AIAction AIBOSS1DYING = new GlobalMembers.ConActions.AIAction(ABOSS1DYING, BOSS1STOPPED, faceplayer);
    static GlobalMembers.ConActions.AIAction AIBOSS1PALSHRINK = new GlobalMembers.ConActions.AIAction(ABOSS1WALK, PALBOSS1SHRUNKRUNVELS, furthestdir);
    ...
    {
        GlobalMembers.ConActions.cactor(BOSS1);
    }
    ...
    static GlobalMembers.ConActions.ConAction ABOSS2WALK = new GlobalMembers.ConActions.ConAction(0, 4, 5, 1, 30);
    static GlobalMembers.ConActions.ConAction ABOSS2FROZEN = new GlobalMembers.ConActions.ConAction(0, 1, 5);
    static GlobalMembers.ConActions.ConAction ABOSS2RUN = new GlobalMembers.ConActions.ConAction(0, 4, 5, 1, 15);
    static GlobalMembers.ConActions.ConAction ABOSS2SHOOT = new GlobalMembers.ConActions.ConAction(20, 2, 5, 1, 15);
    static GlobalMembers.ConActions.ConAction ABOSS2LOB = new GlobalMembers.ConActions.ConAction(30, 2, 5, 1, 105);
    static GlobalMembers.ConActions.ConAction ABOSS2DYING = new GlobalMembers.ConActions.ConAction(40, 8, 1, 1, 35);
    static GlobalMembers.ConActions.ConAction BOSS2FLINTCH = new GlobalMembers.ConActions.ConAction(40, 1, 1, 1, 1);
    static GlobalMembers.ConActions.ConAction ABOSS2DEAD = new GlobalMembers.ConActions.ConAction(48);
    static GlobalMembers.ConActions.MoveAction PALBOSS2SHRUNKRUNVELS = new GlobalMembers.ConActions.MoveAction(32);
    static GlobalMembers.ConActions.MoveAction PALBOSS2RUNVELS = new GlobalMembers.ConActions.MoveAction(84);
    static GlobalMembers.ConActions.MoveAction BOSS2WALKVELS = new GlobalMembers.ConActions.MoveAction(192);
    static GlobalMembers.ConActions.MoveAction BOSS2RUNVELS = new GlobalMembers.ConActions.MoveAction(256);
    static GlobalMembers.ConActions.MoveAction BOSS2STOPPED = new GlobalMembers.ConActions.MoveAction();
    static GlobalMembers.ConActions.AIAction AIBOSS2SEEKENEMY = new GlobalMembers.ConActions.AIAction(ABOSS2WALK, BOSS2WALKVELS, seekplayer);
    static GlobalMembers.ConActions.AIAction AIBOSS2RUNENEMY = new GlobalMembers.ConActions.AIAction(ABOSS2RUN, BOSS2RUNVELS, faceplayer);
    static GlobalMembers.ConActions.AIAction AIBOSS2SHOOTENEMY = new GlobalMembers.ConActions.AIAction(ABOSS2SHOOT, BOSS2STOPPED, faceplayer);
    static GlobalMembers.ConActions.AIAction AIBOSS2LOBBED = new GlobalMembers.ConActions.AIAction(ABOSS2LOB, BOSS2STOPPED, faceplayer);
    static GlobalMembers.ConActions.AIAction AIBOSS2DYING = new GlobalMembers.ConActions.AIAction(ABOSS2DYING, BOSS2STOPPED, faceplayer);
    static GlobalMembers.ConActions.AIAction AIBOSS2PALSHRINK = new GlobalMembers.ConActions.AIAction(ABOSS2WALK, PALBOSS2SHRUNKRUNVELS, furthestdir);
    ...
    static GlobalMembers.ConActions.ConAction ABOSS3WALK = new GlobalMembers.ConActions.ConAction(0, 4, 5, 1, 30);
    static GlobalMembers.ConActions.ConAction ABOSS3FROZEN = new GlobalMembers.ConActions.ConAction(0, 1, 5);
    static GlobalMembers.ConActions.ConAction ABOSS3RUN = new GlobalMembers.ConActions.ConAction(0, 4, 5, 1, 15);
    static GlobalMembers.ConActions.ConAction ABOSS3LOB = new GlobalMembers.ConActions.ConAction(20, 4, 5, 1, 50);
    static GlobalMembers.ConActions.ConAction ABOSS3LOBBING = new GlobalMembers.ConActions.ConAction(30, 2, 5, 1, 15);
    static GlobalMembers.ConActions.ConAction ABOSS3DYING = new GlobalMembers.ConActions.ConAction(40, 8, 1, 1, 20);
    static GlobalMembers.ConActions.ConAction BOSS3FLINTCH = new GlobalMembers.ConActions.ConAction(40, 1, 1, 1, 1);
    static GlobalMembers.ConActions.ConAction ABOSS3DEAD = new GlobalMembers.ConActions.ConAction(48);
    static GlobalMembers.ConActions.MoveAction PALBOSS3SHRUNKRUNVELS = new GlobalMembers.ConActions.MoveAction(32);
    static GlobalMembers.ConActions.MoveAction PALBOSS3RUNVELS = new GlobalMembers.ConActions.MoveAction(84);
    static GlobalMembers.ConActions.MoveAction BOSS3WALKVELS = new GlobalMembers.ConActions.MoveAction(208);
    static GlobalMembers.ConActions.MoveAction BOSS3RUNVELS = new GlobalMembers.ConActions.MoveAction(270);
    static GlobalMembers.ConActions.MoveAction BOSS3STOPPED = new GlobalMembers.ConActions.MoveAction();
    static GlobalMembers.ConActions.AIAction AIBOSS3SEEKENEMY = new GlobalMembers.ConActions.AIAction(ABOSS3WALK, BOSS3WALKVELS, seekplayer);
    static GlobalMembers.ConActions.AIAction AIBOSS3RUNENEMY = new GlobalMembers.ConActions.AIAction(ABOSS3RUN, BOSS3RUNVELS, faceplayerslow);
    static GlobalMembers.ConActions.AIAction AIBOSS3LOBENEMY = new GlobalMembers.ConActions.AIAction(ABOSS3LOB, BOSS3STOPPED, faceplayer);
    static GlobalMembers.ConActions.AIAction AIBOSS3DYING = new GlobalMembers.ConActions.AIAction(ABOSS3DYING, BOSS3STOPPED, faceplayer);
    static GlobalMembers.ConActions.AIAction AIBOSS3PALSHRINK = new GlobalMembers.ConActions.AIAction(ABOSS3WALK, PALBOSS3SHRUNKRUNVELS, faceplayer);
    ...
    static GlobalMembers.ConActions.ConAction ACOMMBREETH = new GlobalMembers.ConActions.ConAction(0, 3, 5, 1, 40);
    static GlobalMembers.ConActions.ConAction ACOMMFROZEN = new GlobalMembers.ConActions.ConAction(0, 1, 5);
    static GlobalMembers.ConActions.ConAction ACOMMSPIN = new GlobalMembers.ConActions.ConAction(-5, 1, 5, 1, 12);
    static GlobalMembers.ConActions.ConAction ACOMMGET = new GlobalMembers.ConActions.ConAction(0, 3, 5, 1, 30);
    static GlobalMembers.ConActions.ConAction ACOMMSHOOT = new GlobalMembers.ConActions.ConAction(20, 1, 5, 1, 35);
    static GlobalMembers.ConActions.ConAction ACOMMABOUTTOSHOOT = new GlobalMembers.ConActions.ConAction(20, 1, 5, 1, 30);
    static GlobalMembers.ConActions.ConAction ACOMMDYING = new GlobalMembers.ConActions.ConAction(30, 8, 1, 1, 12);
    static GlobalMembers.ConActions.ConAction ACOMMDEAD = new GlobalMembers.ConActions.ConAction(38, 1, 1, 1, 1);
    static GlobalMembers.ConActions.MoveAction COMMGETUPVELS = new GlobalMembers.ConActions.MoveAction(128, -64);
    static GlobalMembers.ConActions.MoveAction COMMGETVELS = new GlobalMembers.ConActions.MoveAction(128, 64);
    static GlobalMembers.ConActions.MoveAction COMMSLOW = new GlobalMembers.ConActions.MoveAction(64, 24);
    static GlobalMembers.ConActions.MoveAction COMMSTOPPED = new GlobalMembers.ConActions.MoveAction();
    static GlobalMembers.ConActions.AIAction AICOMMWAIT = new GlobalMembers.ConActions.AIAction(ACOMMBREETH, COMMSTOPPED, faceplayerslow);
    static GlobalMembers.ConActions.AIAction AICOMMGET = new GlobalMembers.ConActions.AIAction(ACOMMGET, COMMGETVELS, seekplayer);
    static GlobalMembers.ConActions.AIAction AICOMMSHOOT = new GlobalMembers.ConActions.AIAction(ACOMMSHOOT, COMMSTOPPED, faceplayerslow);
    static GlobalMembers.ConActions.AIAction AICOMMABOUTTOSHOOT = new GlobalMembers.ConActions.AIAction(ACOMMABOUTTOSHOOT, COMMSTOPPED, faceplayerslow);
    static GlobalMembers.ConActions.AIAction AICOMMSPIN = new GlobalMembers.ConActions.AIAction(ACOMMSPIN, COMMGETVELS, spin);
    static GlobalMembers.ConActions.AIAction AICOMMDYING = new GlobalMembers.ConActions.AIAction(ACOMMDYING, COMMSTOPPED, faceplayer);
    static GlobalMembers.ConActions.AIAction AICOMMSHRUNK = new GlobalMembers.ConActions.AIAction(ACOMMGET, COMMSLOW, furthestdir);
    static GlobalMembers.ConActions.AIAction AICOMMGROW = new GlobalMembers.ConActions.AIAction(ACOMMGET, COMMSTOPPED, furthestdir);
    ...
    static GlobalMembers.ConActions.MoveAction CANNONBALL1 = new GlobalMembers.ConActions.MoveAction(512, 0);
    static GlobalMembers.ConActions.MoveAction CANNONBALL2 = new GlobalMembers.ConActions.MoveAction(512, 10);
    static GlobalMembers.ConActions.MoveAction CANNONBALL3 = new GlobalMembers.ConActions.MoveAction(512, 20);
    static GlobalMembers.ConActions.MoveAction CANNONBALL4 = new GlobalMembers.ConActions.MoveAction(512, 40);
    static GlobalMembers.ConActions.MoveAction CANNONBALL5 = new GlobalMembers.ConActions.MoveAction(512, 80);
    ...
    static GlobalMembers.ConActions.MoveAction CANNONBALLSVEL = new GlobalMembers.ConActions.MoveAction();
    ...
    static GlobalMembers.ConActions.ConAction ACANNONWAIT = new GlobalMembers.ConActions.ConAction(0, 1, 7, 1, 1);
    static GlobalMembers.ConActions.ConAction ACANNONSHOOTING = new GlobalMembers.ConActions.ConAction(0, 1, 7, 1, 1);
    static GlobalMembers.ConActions.MoveAction CANNONSTOP = new GlobalMembers.ConActions.MoveAction();
    ...
    static GlobalMembers.ConActions.ConAction ASPEAKERBROKE = new GlobalMembers.ConActions.ConAction(1);
    ...
    static GlobalMembers.ConActions.ConAction ALAVABUBBLE = new GlobalMembers.ConActions.ConAction();
    static GlobalMembers.ConActions.ConAction ALAVABUBBLEANIM = new GlobalMembers.ConActions.ConAction(0, 5, 1, 1, 16);
    ...
    static GlobalMembers.ConActions.ConAction ATANKSPIN = new GlobalMembers.ConActions.ConAction(0, 1, 7, 1, 4);
    static GlobalMembers.ConActions.ConAction ATANKSHOOTING = new GlobalMembers.ConActions.ConAction(7, 2, 7, 1, 10);
    static GlobalMembers.ConActions.ConAction ATANKWAIT = new GlobalMembers.ConActions.ConAction(0, 1, 7, 1, 1);
    static GlobalMembers.ConActions.ConAction ATANKDESTRUCT = new GlobalMembers.ConActions.ConAction(0, 1, 7, 1, 1);
    static GlobalMembers.ConActions.ConAction ATANKDEAD = new GlobalMembers.ConActions.ConAction(0, 1, 7, 1, 1);
    static GlobalMembers.ConActions.MoveAction TANKFORWARD = new GlobalMembers.ConActions.MoveAction(100);
    static GlobalMembers.ConActions.MoveAction TANKSTOP = new GlobalMembers.ConActions.MoveAction();
    private void A_TANK()
    {
        GlobalMembers.ConActions.fall();
        if (GlobalMembers.ConActions.ifaction(null))
    ...
    static GlobalMembers.ConActions.ConAction ABOSS4WALK = new GlobalMembers.ConActions.ConAction(0, 4, 5, 1, 30);
    static GlobalMembers.ConActions.ConAction ABOSS4DYING = new GlobalMembers.ConActions.ConAction(40, 9, 1, 1, 20);
    static GlobalMembers.ConActions.ConAction ABOSS4ABOUTTOSHOOT = new GlobalMembers.ConActions.ConAction(20, 1, 5, 1, 40);
    static GlobalMembers.ConActions.ConAction ABOSS4SHOOT = new GlobalMembers.ConActions.ConAction(25, 2, 5, 1, 10);
    static GlobalMembers.ConActions.ConAction ABOSS4LAYIT = new GlobalMembers.ConActions.ConAction(50, 3, 5, 1, 120);
    static GlobalMembers.ConActions.ConAction BOSS4FLINTCH = new GlobalMembers.ConActions.ConAction(40, 1, 1, 1, 1);
    static GlobalMembers.ConActions.ConAction ABOSS4DEAD = new GlobalMembers.ConActions.ConAction(49);
    static GlobalMembers.ConActions.MoveAction BOSS4WALKVELS = new GlobalMembers.ConActions.MoveAction(128);
    static GlobalMembers.ConActions.MoveAction BOSS4STOPPED = new GlobalMembers.ConActions.MoveAction();
    static GlobalMembers.ConActions.AIAction AIBOSS4LAYEGGS = new GlobalMembers.ConActions.AIAction(ABOSS4WALK, BOSS4WALKVELS, randomangle, geth);
    static GlobalMembers.ConActions.AIAction AIBOSS4SHOOT = new GlobalMembers.ConActions.AIAction(ABOSS4ABOUTTOSHOOT, BOSS4STOPPED, faceplayer);
    static GlobalMembers.ConActions.AIAction AIBOSS4DYING = new GlobalMembers.ConActions.AIAction(ABOSS4DYING, BOSS4STOPPED, faceplayer);
    ...
    static GlobalMembers.ConActions.ConAction ANEWBEASTSTAND = new GlobalMembers.ConActions.ConAction(0);
    static GlobalMembers.ConActions.ConAction ANEWBEASTWALKING = new GlobalMembers.ConActions.ConAction(10, 4, 5, 1, 12);
    static GlobalMembers.ConActions.ConAction ANEWBEASTRUNNING = new GlobalMembers.ConActions.ConAction(10, 4, 5, 1, 8);
    static GlobalMembers.ConActions.ConAction ANEWBEASTTHINK = new GlobalMembers.ConActions.ConAction(0, 2, 5, 1, 40);
    static GlobalMembers.ConActions.ConAction ANEWBEASTSCRATCHING = new GlobalMembers.ConActions.ConAction(30, 3, 5, 1, 20);
    static GlobalMembers.ConActions.ConAction ANEWBEASTDYING = new GlobalMembers.ConActions.ConAction(72, 8, 1, 1, 15);
    static GlobalMembers.ConActions.ConAction ANEWBEASTFLINTCH = new GlobalMembers.ConActions.ConAction(71, 1, 1, 1, 1);
    static GlobalMembers.ConActions.ConAction ANEWBEASTLYINGDEAD = new GlobalMembers.ConActions.ConAction(79, 1, 1);
    static GlobalMembers.ConActions.ConAction ANEWBEASTSCREAM = new GlobalMembers.ConActions.ConAction(50, 2, 5, 1, 40);
    static GlobalMembers.ConActions.ConAction ANEWBEASTJUMP = new GlobalMembers.ConActions.ConAction(80, 2, 5, 1, 50);
    static GlobalMembers.ConActions.ConAction ANEWBEASTFALL = new GlobalMembers.ConActions.ConAction(90, 1, 5);
    static GlobalMembers.ConActions.ConAction ANEWBEASTFROZEN = new GlobalMembers.ConActions.ConAction(10, 1, 5);
    static GlobalMembers.ConActions.ConAction ANEWBEASTHANG = new GlobalMembers.ConActions.ConAction(0, 1, 5);
    ...
    static GlobalMembers.ConActions.ConAction ANEWBEASTHANGDEAD = new GlobalMembers.ConActions.ConAction(-1, 1, 5);
    ...
    static GlobalMembers.ConActions.MoveAction NEWBEASTWALKVEL = new GlobalMembers.ConActions.MoveAction(182);
    static GlobalMembers.ConActions.MoveAction NEWBEASTRUNVEL = new GlobalMembers.ConActions.MoveAction(256);
    static GlobalMembers.ConActions.MoveAction NEWBEASTJUMPVEL = new GlobalMembers.ConActions.MoveAction(264);
    static GlobalMembers.ConActions.MoveAction NEWBEASTSTOP = new GlobalMembers.ConActions.MoveAction();
    static GlobalMembers.ConActions.AIAction AINEWBEASTGETENEMY = new GlobalMembers.ConActions.AIAction(ANEWBEASTWALKING, NEWBEASTWALKVEL, seekplayer);
    static GlobalMembers.ConActions.AIAction AINEWBEASTDODGE = new GlobalMembers.ConActions.AIAction(ANEWBEASTRUNNING, NEWBEASTRUNVEL, dodgebullet);
    static GlobalMembers.ConActions.AIAction AINEWBEASTCHARGEENEMY = new GlobalMembers.ConActions.AIAction(ANEWBEASTRUNNING, NEWBEASTRUNVEL, seekplayer);
    static GlobalMembers.ConActions.AIAction AINEWBEASTFLEENEMY = new GlobalMembers.ConActions.AIAction(ANEWBEASTWALKING, NEWBEASTWALKVEL, fleeenemy);
    static GlobalMembers.ConActions.AIAction AINEWBEASTSCRATCHENEMY = new GlobalMembers.ConActions.AIAction(ANEWBEASTSCRATCHING, NEWBEASTSTOP, faceplayerslow);
    static GlobalMembers.ConActions.AIAction AINEWBEASTJUMPENEMY = new GlobalMembers.ConActions.AIAction(ANEWBEASTJUMP, NEWBEASTJUMPVEL, jumptoplayer);
    static GlobalMembers.ConActions.AIAction AINEWBEASTTHINK = new GlobalMembers.ConActions.AIAction(ANEWBEASTTHINK, NEWBEASTSTOP);
    static GlobalMembers.ConActions.AIAction AINEWBEASTGROW = new GlobalMembers.ConActions.AIAction(ANEWBEASTSTAND, NEWBEASTSTOP, faceplayerslow);
    static GlobalMembers.ConActions.AIAction AINEWBEASTDYING = new GlobalMembers.ConActions.AIAction(ANEWBEASTDYING, NEWBEASTSTOP, faceplayer);
    static GlobalMembers.ConActions.AIAction AINEWBEASTSHOOT = new GlobalMembers.ConActions.AIAction(ANEWBEASTSCREAM, NEWBEASTSTOP, faceplayerslow);
    static GlobalMembers.ConActions.AIAction AINEWBEASTFLINTCH = new GlobalMembers.ConActions.AIAction(ANEWBEASTFLINTCH, NEWBEASTSTOP, faceplayerslow);
    ...
    private void newbeastscratchstate()
    {
        ...
        if (GlobalMembers.ConActions.ifactioncount(3))
        {
            if (GlobalMembers.ConActions.ifpdistg(1596))
                ...
                if (GlobalMembers.ConActions.ifp(palive) && GlobalMembers.ConActions.ifcansee())
            {
                GlobalMembers.ConActions.palfrom(16, 16);
    ...
    public ConScript()
    {
        ...
        GlobalMembers.ConActions.RegisterActor(A_WATERBUBBLEMAKER, WATERBUBBLEMAKER, enemy, 0, null/*, randomangle*/); // jmarshall: random angle
        GlobalMembers.ConActions.RegisterActor(A_WATERBUBBLE, WATERBUBBLE, enemy, 0, BUBBLE, BUBMOVE/*, getv, geth, randomangle*/); // jmarshall
        ...
        GlobalMembers.ConActions.RegisterActor(A_FIRE, FIRE, notenemy, WEAK, null, FIREVELS);
        GlobalMembers.ConActions.RegisterActor(A_FIRE2, FIRE2, notenemy, WEAK, null, FIREVELS);
        ...
        GlobalMembers.ConActions.RegisterActor(A_APLAYER, APLAYER, enemy, MAXPLAYERHEALTH, PSTAND, null, 0);
        ...
        GlobalMembers.ConActions.RegisterActor(A_LIZMANSTAYPUT, LIZMANSTAYPUT, enemy, LIZSTRENGTH);
        GlobalMembers.ConActions.RegisterActor(A_LIZMANSPITTING, LIZMANSPITTING, enemy, LIZSTRENGTH);
        GlobalMembers.ConActions.RegisterActor(A_LIZMANJUMP, LIZMANJUMP, enemy, LIZSTRENGTH); 
        ...
        GlobalMembers.ConActions.RegisterActor(A_BOSS1STAYPUT, BOSS1STAYPUT, enemy, BOSS1STRENGTH);
        GlobalMembers.ConActions.RegisterActor(A_BOSS1, BOSS1, enemy, BOSS1STRENGTH);
        GlobalMembers.ConActions.RegisterActor(A_BOSS2, BOSS2, enemy, BOSS2STRENGTH);
        GlobalMembers.ConActions.RegisterActor(A_BOSS3, BOSS3, enemy, BOSS3STRENGTH);
        ...
        GlobalMembers.ConActions.RegisterActor(A_TANK, TANK, enemy, TANKSTRENGTH);
        ...
        GlobalMembers.ConActions.RegisterActor(A_NEWBEASTSTAYPUT, NEWBEASTSTAYPUT, enemystayput, NEWBEASTSTRENGTH); 
        GlobalMembers.ConActions.RegisterActor(A_NEWBEASTJUMP, NEWBEASTJUMP, enemy, NEWBEASTSTRENGTH); 
