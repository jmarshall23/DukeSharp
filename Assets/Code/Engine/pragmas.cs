...
*/
        ...
        public static int fix16_one = 0x00010000;

        public static float fix16_to_float(int a) { return (float)a / fix16_one; }
        public static int fix16_from_int(int a) { return (int)(a * fix16_one); }
